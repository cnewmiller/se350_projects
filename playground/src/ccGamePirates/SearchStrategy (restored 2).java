	...
	protected class SearchNode implements Comparable<Object>{
		...
		public void expandChildren(){
			...
			for (Directions d: Directions.values()) {
				if (childs[d.ordinal()] != null && !this.aStarSearch.seen.containsKey(childs[d.ordinal()])) {
					children[d.ordinal()] = new SearchNode(this.aStarSearch, childs[d.ordinal()], this.aStarSearch.goal, this.aStarSearch.evaluatePoint(p, this.aStarSearch.goal), this, d);
				}
			}
		}
